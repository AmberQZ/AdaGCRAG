...
class QueryParam:
    ...
    response_type: str = "A **short, direct answer** to the question. Do not include commentary, sections, or Markdown formatting."
    stream: bool = False
...
class BaseGraphStorage(StorageNameSpace):
    ...
    async def embed_nodes(self, algorithm: str) -> tuple[np.ndarray, list[str]]:
        raise NotImplementedError("Node embedding is not used in adarag.")
